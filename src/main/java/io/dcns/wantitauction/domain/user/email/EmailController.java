...
public class EmailController {
    ...
    public ResponseEntity<ResponseDto<String>> sendEmailPath(@RequestBody EmailSignupRequestDto requestDto)
    ...
    public ResponseEntity<ResponseDto<Boolean>> sendEmailAndCode(@RequestBody EmailRequestDto requestDto)
