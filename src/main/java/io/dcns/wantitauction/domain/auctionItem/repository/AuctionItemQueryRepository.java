...
public class AuctionItemQueryRepository {
    ...
    public Page<FinishedItemResponseDto> findWinningAuctionItems(
            Long userId,
            Pageable pageable) {
    ...
    public FinishedItemResponseDto findWinningAuctionItem(
            Long auctionItemId,
            Long userId) {
    ...
    public Page<MyAuctionItemsResponseDto> findAllMyAuctionItems(
            Long userId,
            Pageable pageable) {
        Long totalSize = jpaQueryFactory
                .select(Wildcard.count)
    ...
    public Page<InProgressItemResponseDto> findAllByInProgress(
            Pageable pageable,
            String category) {
        Long totalSize = jpaQueryFactory
                .select(Wildcard.count)
